      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-4 sm:gap-4.5">
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200/80 shadow-2xs card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-3xl sm:text-4xl font-black text-slate-900 font-mono tracking-tight">{totalManholes}</div>
            <div className="text-xs text-slate-400 font-bold">Struktur Titik Node</div>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200/80 shadow-2xs card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-3xl sm:text-4xl font-black text-slate-900 font-mono tracking-tight">{totalPipes}</div>
            <div className="text-xs text-slate-400 font-bold">Segmen Pipa Kolektor</div>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200/80 shadow-2xs card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-3xl sm:text-4xl font-black text-slate-900 font-mono tracking-tight">{totalPumpStations}</div>
            <div className="text-xs text-slate-400 font-bold">Outlet Pompa Utama</div>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200/80 shadow-2xs card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-3xl sm:text-4xl font-black text-emerald-600 font-mono tracking-tight">{totalActive}</div>
            <div className="text-xs text-slate-400 font-bold">{((totalActive / totalAssets) * 100).toFixed(0)}% Normal</div>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200/80 shadow-2xs card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-3xl sm:text-4xl font-black text-amber-600 font-mono tracking-tight">{needingInspection}</div>
            <div className="text-xs text-slate-400 font-bold">Pending / Review</div>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200/80 shadow-2xs card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-3xl sm:text-4xl font-black text-rose-600 font-mono tracking-tight">{totalProblematic}</div>
            <div className="text-xs text-slate-400 font-bold">{criticalAssets.length} Critical • {warningAssets.length} Warning</div>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200/80 shadow-2xs card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-3xl sm:text-4xl font-black text-purple-600 font-mono tracking-tight">{overdueInspectionCount}</div>
            <div className="text-xs text-slate-400 font-bold">Jatuh Tempo Lewat</div>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white p-6 sm:p-7 rounded-xl border border-slate-200/80 shadow-2xs space-y-5">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div>
                ...
                <p className="text-xs text-slate-500 font-semibold mt-0.5">Proporsi fisik jaringan berdasarkan hasil inspeksi teknis</p>
              </div>
            ...
            <div className="space-y-2">
              <div className="h-6 w-full bg-slate-100 rounded-full overflow-hidden flex p-0.5 border border-slate-200/80 shadow-inner">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5 pt-2">
                <div className="bg-slate-50/90 p-4 rounded-xl border border-slate-200/80 space-y-1">
                  <div className="text-xs text-slate-500 font-extrabold flex items-center justify-between">
                    <span>Good (Baik)</span>
                    <span className="w-2.5 h-2.5 rounded-full bg-[#4ADE80]"></span>
                  </div>
                  <div className="text-3xl font-black text-emerald-600 font-mono mt-1">{goodCount}</div>
                  <div className="text-xs text-slate-500 font-bold">{((goodCount / totalAssets) * 100).toFixed(0)}% dari total</div>
                </div>
                ...
                <div className="bg-slate-50/90 p-4 rounded-xl border border-slate-200/80 space-y-1">
                  ...
                  <div className="text-3xl font-black text-sky-600 font-mono mt-1">{fairCount}</div>
                  <div className="text-xs text-slate-500 font-bold">{((fairCount / totalAssets) * 100).toFixed(0)}% dari total</div>
                </div>
                ...
                <div className="bg-slate-50/90 p-4 rounded-xl border border-slate-200/80 space-y-1">
                  ...
                  <div className="text-3xl font-black text-amber-600 font-mono mt-1">{warningAssets.length}</div>
                  <div className="text-xs text-slate-500 font-bold">{((warningAssets.length / totalAssets) * 100).toFixed(0)}% dari total</div>
                </div>
                ...
                <div className="bg-slate-50/90 p-4 rounded-xl border border-slate-200/80 space-y-1">
                  ...
                  <div className="text-3xl font-black text-rose-600 font-mono mt-1">{criticalAssets.length}</div>
                  <div className="text-xs text-slate-500 font-bold">{((criticalAssets.length / totalAssets) * 100).toFixed(0)}% dari total</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 sm:p-7 rounded-xl border border-slate-200/80 shadow-2xs space-y-4 flex flex-col">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div>
                ...
                <p className="text-xs text-slate-500 font-semibold mt-0.5">Aset berkondisi Critical & Warning yang memerlukan perbaikan</p>
              </div>
            ...
            <div className="space-y-3 max-h-[360px] overflow-y-auto pr-1">
              {problematicAssets.length === 0 ? (
                ...
                problematicAssets.map(asset => (
                  <div
                    key={asset.id}
                    className="p-4 bg-slate-50 hover:bg-slate-100/90 rounded-xl border border-slate-200/80 flex items-center justify-between transition group"
                  >
                    <div className="space-y-1">
                      ...
                      <div className="text-xs text-slate-500 font-semibold">{asset.area}</div>
                    </div>
                    ...
                    <button
                      ...
                      className="text-xs bg-white text-[#2563EB] font-extrabold px-3.5 py-2 rounded-xl border border-slate-200 shadow-2xs hover:bg-blue-50 transition shrink-0 flex items-center gap-1.5 hover:scale-105"
                    >
                      <span>Buka Peta</span>
          ...
          <div className="bg-white p-6 sm:p-7 rounded-xl border border-slate-200/80 shadow-2xs space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div>
                ...
                <p className="text-xs text-slate-500 font-semibold mt-0.5">Catatan temuan inspeksi lapangan terkini</p>
              </div>
              <button onClick={() => onNavigate('inspections')} className="text-xs text-[#2563EB] font-extrabold hover:underline">
                Lihat Semua →
              </button>
            </div>
            ...
            <div className="space-y-3">
              {recentInspections.map(insp => (
                <div key={insp.id} className="p-3.5 bg-slate-50 rounded-xl border border-slate-200/70 space-y-2">
                  ...
                  <p className="text-xs text-slate-600 font-medium leading-relaxed">{insp.notes}</p>
