    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 w-full max-w-[1920px] mx-auto font-sans min-h-[calc(100vh-70px)] flex flex-col">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-4 sm:gap-5">
          {/* 1. Total Manhole */}
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md transition-all duration-200 card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-xs text-slate-400 dark:text-slate-500 font-bold">Struktur Titik Node</div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md transition-all duration-200 card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-xs text-slate-400 dark:text-slate-500 font-bold">Segmen Pipa Kolektor</div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md transition-all duration-200 card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-xs text-slate-400 dark:text-slate-500 font-bold">Outlet Pompa Utama</div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md transition-all duration-200 card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-xs text-slate-400 dark:text-slate-500 font-bold">{((totalActive / totalAssets) * 100).toFixed(0)}% Normal</div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md transition-all duration-200 card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-xs text-slate-400 dark:text-slate-500 font-bold">Pending / Review</div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md transition-all duration-200 card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-xs text-slate-400 dark:text-slate-500 font-bold">{criticalAssets.length} Critical • {warningAssets.length} Warning</div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md transition-all duration-200 card-hover flex flex-col justify-between space-y-2">
            ...
            <div className="text-xs text-slate-400 dark:text-slate-500 font-bold">Jatuh Tempo Lewat</div>
          </div>
        </div>
      </div>
